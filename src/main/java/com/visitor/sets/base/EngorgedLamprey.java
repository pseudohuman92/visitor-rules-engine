...
public class EngorgedLamprey extends Unit {
	...
	public EngorgedLamprey (Game game, String owner) {
		...
		playable.addEnterPlayEffectWithKnowledge(
				...
				() -> {
					Arraylist<UUID> sacrificedIds = game.selectFromZone(controller, Game.Zone.Play, Predicates::isUnit, 1, true, "You may sacrifice a unit.");
