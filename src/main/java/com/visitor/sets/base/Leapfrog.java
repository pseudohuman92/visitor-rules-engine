...
public class Leapfrog extends Unit {
	...
	public Leapfrog (Game game, UUID owner) {
		...
		activatable.addActivatedAbility(new ActivatedAbility(
				...
				.addBeforeActivate(()->{
					damageTarget = game.selectDamageTargets(controller, 1, false, "Choose a target to damage.").get(0);
					purgeTargets = game.selectFromZone(controller, Game.Zone.Discard_Pile, Predicates::any, 2, false, "Choose 2 cards to purge.");
